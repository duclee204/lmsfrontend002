...
export class CategoryComponent implements OnInit {
  ...
  submitCategory(): void {
    ...
    if (this.isEditing && this.editId !== null) {
      ...
      this.http.put(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/categories/${this.editId}`, this.newCategory, {
        responseType: 'text'
      }).subscribe({
        next: (res) => {
  ...
  deleteCategory(): void {
    ...
    this.http.delete(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/categories/${this.editId}`, { responseType: 'text' })
      .subscribe({
        next: (res) => {
          this.showAlert(res, 'success');
          this.fetchCategories();
