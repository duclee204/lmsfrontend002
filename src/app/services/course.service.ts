...
export class CourseService {
  private baseUrl = 'https://lms-backend001-110ad185d2b7.herokuapp.com/api/courses';
  ...
  getEnrollmentStatistics(): Observable<any> {
    ...
    return this.http.get<any>(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/enrollments/statistics`, { headers });
  }
  ...
  getInstructorEnrollmentStatistics(): Observable<any> {
    ...
    return this.http.get<any>(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/enrollments/instructor-statistics`, { headers })
      .pipe(
        catchError((error) => {
  ...
  getInstructorEnrollments(): Observable<Enrollment[]> {
    ...
    return this.http.get<Enrollment[]>(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/enrollments/instructor`, { headers })
      .pipe(
        catchError((error) => {
  ...
  getAllEnrollments(): Observable<Enrollment[]> {
    ...
    return this.http.get<Enrollment[]>(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/enrollments`, { headers });
  }
