...
export class PaymentService {
  private apiUrl = 'https://lms-backend001-110ad185d2b7.herokuapp.com/api/payments';
  ...
  checkPaymentByTransaction(transactionId: string): Observable<any> {
    return this.http.get<any>(`https://lms-backend001-110ad185d2b7.herokuapp.com/api/payment-status/check/${transactionId}`);
  }
